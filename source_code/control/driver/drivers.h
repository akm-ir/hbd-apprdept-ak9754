...
#ifndef INCLUDE_DRIVERS_H
#define INCLUDE_DRIVERS_H
...
enum {
    I2C_SUCCESS = 0,
    I2C_ERROR,                       /* i2c communication failed */
};
 ...
 */
extern int32_t I2C_Write(uint8_t slave_addr, uint8_t w_cmd, uint8_t cmd_data);
...
/**
  ...
  * @retval I2C_ERROR on error
  */
extern int32_t I2C_Read(uint8_t slave_addr, uint8_t r_cmd, uint8_t num_data,
                        uint8_t *pbuf);
...
/**
  ...
  * @return None
  */
extern void WaitMsec(int32_t msec);
...
#endif /* !defined(INCLUDE_DRIVERS_H) */
